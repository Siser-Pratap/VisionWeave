    ...
    <div className='absolute z-[0] w-full'>
      <nav ref={nav} class="bg-[#151030]">
        <div class="max-w-screen-xl flex no-wrap w-full items-center justify-between p-6 ">
          ...
          <div class="flex justify-center items-center gap-[4px] md:gap-[8px] md:order-2 ">
              ...
              <div className='cursor-pointer'><svg className="text-white w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="white" x="0px" y="0px" width="" height="" viewBox="0 0 50 50">
