    ...
    <div className='absolute z-[0] w-full'>
      <nav ref={nav} class="bg-[#151030] min-w-md ">
        <div class="max-w-screen-xl ml-[20px] flex flex-wrap w-full items-center  justify-between p-6 min-w-">
          ...
          <div class="flex justify-center items-center gap-[2px] md:order-2  ">
              <button type="button" class="font-medium justify-end rounded-[20px] text-white text-sm px-4 py-2 text-center bg-secondary hover:bg-tertiary font-[Ancient] text-[1.3rem] ">Create</button>
              <div className='ml-[10px] cursor-pointer'><svg className="text-white w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="white" x="0px" y="0px" width="" height="" viewBox="0 0 50 50">
    ...
    <div ref={back} className='h-[100vh] absolute z-[-1] w-full min-w-[254px] '>
      <div className='w-auto robot h-full bg-robot-pattern bg-cover bg-no-repeat bg-center backdrop-blur-md'>
        ...
        <div class="h-full w-full flex flex-col justify-center items-baseline left-[50px] ml-[20vw]" >
            <ul class="flex flex-col navVal gap-[20px] mb-[20px]">
