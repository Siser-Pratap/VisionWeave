...
const App = () => {
 ...
 useEffect(()=>{
  ...
  <div className='relative '>
    ...
    <div ref={back} className='h-[100vh] absolute z-[-1] w-full min-w-[254px] bg-robot-pattern bg-cover bg-no-repeat bg-center '>
      <div className='w-full h-full '>
        ...
        <div class="h-full w-full flex flex-col justify-center items-baseline left-[50px] ml-[20vw]" >
            <ul class="flex flex-col navVal gap-[20px]">
